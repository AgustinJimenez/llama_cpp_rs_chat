...
static ALL_TOOLS: &[ToolDef] = &[
    ...
    ToolDef {
        ...
        params: Params::Simple(&[
            ...
            p("summary_prompt", "string", "Custom instructions for the summarizer (e.g. 'extract the main article text only')."),
        ]),
        required: &["url"],
    },
    // ─── 13. open_url ───
    ...
    ToolDef {
        ...
        params: Params::Simple(&[
            ...
            p("summary_prompt", "string", "Custom instructions for the summarizer (e.g. 'extract all article titles and URLs', 'find the pricing table'). Overrides the default summary prompt."),
        ]),
        required: &[],
    },
    ToolDef {
        ...
        params: Params::Simple(&[
            ...
            p("summary_prompt", "string", "Custom instructions for the summarizer (e.g. 'extract only article links, skip navigation')."),
        ]),
        required: &[],
    },
    ToolDef {
        ...
        params: Params::Simple(&[
            ...
            p("summary_prompt", "string", "Custom instructions for the summarizer."),
        ]),
        required: &[],
    },
    ToolDef {
