...
pub(crate) fn escape_newlines_in_json_strings(input: &str) -> String {
...
pub(crate) fn auto_close_json(input: &str) -> String {
...
/// JSON escapes (`\"`, `\\`, `\/`, `\b`, `\f`, `\n`, `\r`, `\t`, `\uXXXX`).
pub(crate) fn escape_invalid_backslashes_in_strings(input: &str) -> String {
...
pub(crate) fn try_parse_with_fixups(input: &str) -> Option<Value> {
    // 1. Try as-is
...
pub(crate) fn value_as_bool_flexible(v: &Value) -> Option<bool> {
