...
pub(crate) fn desktop_trace_path() -> std::path::PathBuf {
...
pub(crate) fn classify_desktop_result_status(text: &str) -> &'static str {
...
pub(crate) struct VerificationRegion {
    pub(super) x: i32,
    pub(super) y: i32,
    pub(super) width: u32,
...
pub(crate) struct ScreenVerificationContext {
...
pub(crate) fn normalize_verification_region(
    x: i32,
    y: i32,
    width: u32,
    height: u32,
...
pub(crate) fn action_verification_region_from_args(args: &Value) -> Option<VerificationRegion> {
...
pub(crate) fn capture_screen_state(
...
pub(crate) fn prepare_screen_verification(
    args: &Value,
    region: Option<VerificationRegion>,
...
pub(crate) fn finalize_action_result(
    summary: String,
    delay_ms: u64,
    do_screenshot: bool,
...
pub(crate) fn summarize_value_for_trace(value: &Value) -> Value {
    match value {
        Value::String(s) => {
...
pub(crate) fn write_desktop_trace_line(entry: &Value) {
...
pub(crate) fn finalize_desktop_result(name: &str, args: &Value, started_at: std::time::Instant, mut result: NativeToolResult) -> NativeToolResult {
...
pub(crate) fn capture_post_action_screenshot_ext(
    delay_ms: u64,
...
pub(crate) fn capture_post_action_screenshot(delay_ms: u64) -> NativeToolResult {
