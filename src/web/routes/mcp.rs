...
use crate::web::{
    ...
    mcp::config::{McpServerConfig, McpTransport},
    request_parsing::parse_json_body,
    response_helpers::{json_error, json_success, json_raw},
    worker::worker_bridge::SharedWorkerBridge,
    worker::ipc_types::WorkerPayload,
};
...
pub async fn handle_list_mcp_servers(
    ...
    let servers = crate::web::database::mcp::load_mcp_servers(&db);
...
pub async fn handle_save_mcp_server(
    ...
    match crate::web::database::mcp::save_mcp_server(&db, &config) {
...
pub async fn handle_delete_mcp_server(
    ...
    match crate::web::database::mcp::delete_mcp_server(&db, id) {
...
pub async fn handle_toggle_mcp_server(
    ...
    match crate::web::database::mcp::toggle_mcp_server(&db, id, body.enabled) {
