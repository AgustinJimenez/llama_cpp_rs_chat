...
const TAG_FIELDS = [
  ...
  {
    key: 'tool_tag_output_open' as keyof SamplerConfig,
    label: 'Output Open',
    descKey: 'output_open',
  },
  {
    key: 'tool_tag_output_close' as keyof SamplerConfig,
    label: 'Output Close',
    descKey: 'output_close',
  },
] as const;
    ...
    <div className="rounded-md border border-border px-3 py-2 space-y-2">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-2">
        {TAG_FIELDS.map((field) => {
          const placeholder = detected?.[field.descKey as keyof typeof detected] ?? '';
