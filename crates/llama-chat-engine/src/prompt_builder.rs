...
pub(crate) fn resolve_tool_tags(config: &SamplerConfig, general_name: Option<&str>) -> ToolTags {
...
pub(crate) fn snapshot_context_overhead(
...
#[cfg(feature = "vision")]
pub(crate) fn inject_tool_response_with_vision(
...
#[cfg(feature = "vision")]
pub(crate) fn inject_media_markers(prompt: &str, user_message: &str, count: usize) -> String {
    let markers = "<__media__>\n".repeat(count);
