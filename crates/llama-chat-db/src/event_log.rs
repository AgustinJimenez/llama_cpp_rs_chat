...
// Re-export ConversationEvent from the shared types crate
pub use llama_chat_types::event_log::ConversationEvent;
...
pub fn init_event_log(db: SharedDatabase) {
...
fn flush_to_db(db: &SharedDatabase, batch: &[(String, ConversationEvent)]) {
