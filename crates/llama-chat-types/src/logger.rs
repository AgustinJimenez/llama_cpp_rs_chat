...
macro_rules! log_debug {
    ($conv_id:expr, $($arg:tt)*) => {
        $crate::logger::LOGGER.debug($conv_id, &format!($($arg)*));
    };
}
...
macro_rules! log_info {
    ($conv_id:expr, $($arg:tt)*) => {
        $crate::logger::LOGGER.info($conv_id, &format!($($arg)*));
    };
}
...
macro_rules! log_warn {
    ($conv_id:expr, $($arg:tt)*) => {
        $crate::logger::LOGGER.warn($conv_id, &format!($($arg)*));
    };
}
...
macro_rules! log_error {
    ($conv_id:expr, $($arg:tt)*) => {
        $crate::logger::LOGGER.error($conv_id, &format!($($arg)*));
    };
}
...
macro_rules! sys_debug {
    ($($arg:tt)*) => {
        $crate::logger::LOGGER.debug("system", &format!($($arg)*));
    };
}
...
macro_rules! sys_info {
    ($($arg:tt)*) => {
        $crate::logger::LOGGER.info("system", &format!($($arg)*));
    };
}
...
macro_rules! sys_warn {
    ($($arg:tt)*) => {
        $crate::logger::LOGGER.warn("system", &format!($($arg)*));
    };
}
...
macro_rules! sys_error {
    ($($arg:tt)*) => {
        $crate::logger::LOGGER.error("system", &format!($($arg)*));
    };
}
